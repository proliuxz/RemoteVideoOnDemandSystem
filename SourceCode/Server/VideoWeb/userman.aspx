<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userman.aspx.cs" Inherits="userman" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>用户管理功能菜单</title>
    ...
    <div id="div1" runat="server" style="width: 1280px; height:720px;  margin-left: 0px; margin-right:  0px; margin-top: 0px; border-right: #000000 0px; border-top: #000000 0px; border-left: #000000 0px; border-bottom: #000000 0px;" align="center">
     ...
     <table style="width: 100%;height:100%">
            <tr style="height:150px">
                <td align="center" >
                   <asp:Label ID="Label1" runat="server" Text="用户管理功能菜单" Font-Bold="True" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button1" runat="server" Text="用户添加"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button2" runat="server" Text="用户查询"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button3" runat="server" Text="用户信息修改"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button4" runat="server" Text="用户删除"  Font-Size="25pt" 
