<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userquery.aspx.cs" Inherits="adminusr" %>
        ...
        <table style="width: 100%;height:100%">
            <tr style="height:150px" >
                <td align="center" colspan="3">
                   <asp:Label ID="Label1" runat="server" Text="用户信息查询" Font-Bold="True" 
            ...
            <Columns>
                 <asp:BoundField DataField="ID" HeaderText="用户编号" ControlStyle-Width="200px" ItemStyle-Width="200px" >
                  <ControlStyle Width="200px"></ControlStyle>
                  <ItemStyle Width="200px"></ItemStyle>
               </asp:BoundField>
                
                <asp:BoundField DataField="userid" HeaderText="用户名" ControlStyle-Width="300px" ItemStyle-Width="300px" >
                  <ControlStyle Width="300px"></ControlStyle>
                  <ItemStyle Width="300px"></ItemStyle>
               </asp:BoundField>
               
                <asp:BoundField DataField="password" HeaderText="密码" ControlStyle-Width="300px" ItemStyle-Width="300px" >
                  <ControlStyle Width="300px"></ControlStyle>
                  <ItemStyle Width="300px"></ItemStyle>
                </asp:BoundField>
                ...
                <asp:BoundField DataField="loggedtimes" HeaderText="登陆次数" ControlStyle-Width="300px" ItemStyle-Width="300px" >
                  <ControlStyle Width="300px"></ControlStyle>
                  <ItemStyle Width="300px"></ItemStyle>
                </asp:BoundField>
