<%@ Page Language="C#" AutoEventWireup="true" CodeFile="classord.aspx.cs" Inherits="class_ord" %>
    ...
    <div id="div1" runat="server" style="width: 1280px; height:720px;  margin-left: 0px; margin-right:  0px; margin-top: 0px; border-right: #000000 0px; border-top: #000000 0px; border-left: #000000 0px; border-bottom: #000000 0px;" align="center">
     ...
     <table style="width: 100%;height:100%">
            <tr style="height:150px">
                <td align="center" >
                   <asp:Label ID="Label1" runat="server" Text="课程订制" Font-Bold="True" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button1" runat="server" Text="订制课程"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button2" runat="server" Text="订制视频"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button3" runat="server" Text="批量订制"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button4" runat="server" Text="订制查询"  Font-Size="25pt" 
