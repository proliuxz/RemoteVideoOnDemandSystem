<%@ Page Language="C#" AutoEventWireup="true" CodeFile="companyman.aspx.cs" Inherits="companyman" %>
    ...
    <div id="div1" runat="server" style="width: 1280px; height:720px;  margin-left: 0px; margin-right:  0px; margin-top: 0px; border-right: #000000 0px; border-top: #000000 0px; border-left: #000000 0px; border-bottom: #000000 0px;" align="center">
     ...
     <table style="width: 100%;height:100%">
            <tr style="height:150px">
                <td align="center" >
                   <asp:Label ID="Label1" runat="server" Text="企业管理功能菜单" Font-Bold="True" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button1" runat="server" Text="企业添加"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button2" runat="server" Text="企业查询"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button3" runat="server" Text="企业信息修改"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button4" runat="server" Text="企业删除"  Font-Size="25pt" 
