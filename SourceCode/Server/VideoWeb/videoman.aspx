<%@ Page Language="C#" AutoEventWireup="true" CodeFile="videoman.aspx.cs" Inherits="videoman" %>
    ...
    <div id="div1" runat="server" style="width: 1280px; height:720px;  margin-left: 0px; margin-right:  0px; margin-top: 0px; border-right: #000000 0px; border-top: #000000 0px; border-left: #000000 0px; border-bottom: #000000 0px;" align="center">
     ...
     <table style="width: 100%;height:100%">
            <tr style="height:150px">
                <td align="center" >
                   <asp:Label ID="Label1" runat="server" Text="视频管理功能菜单" Font-Bold="True" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button1" runat="server" Text="视频添加"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button2" runat="server" Text="视频查询"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button3" runat="server" Text="视频信息修改"  Font-Size="25pt" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button4" runat="server" Text="视频删除"  Font-Size="25pt" 
