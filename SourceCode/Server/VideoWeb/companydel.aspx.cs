...
public partial class companydel : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Del")
        {
            ...
            System.IO.File.Delete(Server.MapPath(@".\image\company\'" + id + ".jpg'"));
            string article = "delete from company where ID=" + id + "";
             OleDbConnection myConn = new OleDbConnection(ConnAcc);
            myConn.Open();
            OleDbCommand cmd = new OleDbCommand(article, myConn);
            cmd.ExecuteNonQuery();
            Label2.Text = "删除成功";
            Response.Redirect("companydel.aspx");
        }
        Bind();
    }
    ...
    {
        string s_url;
        s_url = "companydel.aspx?x1=" + DropDwonList1.Text + "&x2=" + TextBox1.Text + "";
