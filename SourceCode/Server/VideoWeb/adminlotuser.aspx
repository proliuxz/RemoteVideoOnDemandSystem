<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminlotuser.aspx.cs" Inherits="adminlotuser" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>集群用户管理页面</title>
</head>
...
<table style="width: 100%;height:100%">
            <tr style="height:150px">
                <td align="center" >
                   <asp:Label ID="Label1" runat="server" Text="集群用户管理" Font-Bold="True" 
            ...
            <tr style="height:100px">
                <td align="center">
                    <asp:Button ID="Button2" runat="server" Text="视频订制"  Font-Size="25pt" 
