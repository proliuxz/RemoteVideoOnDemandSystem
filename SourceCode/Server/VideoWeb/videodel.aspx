<%@ Page Language="C#" AutoEventWireup="true" CodeFile="videodel.aspx.cs" Inherits="videodel" %>
    ...
    <div id="div1" runat="server" style="width: 1280px; height:720px;  margin-left: 0px; margin-right:  0px; margin-top: 0px; border-right: #000000 0px ; border-top: #000000 0px ; border-left: #000000 0px ; border-bottom: #000000 0px ;" align="center">
     ...
     <tr style="height:150px">
       ...
       <td style="width:1200px"  >
           <asp:Label ID="Label1" runat="server" Text="视频删除" Font-Bold="False" 
               ...
               <tr >
                   <td style="width:200px; " align="center" valign="top">
                    <asp:DropDownList ID="DropDwonList1" runat="server"  Height="40px" Width="200px" Font-Size="20pt">
                        ...
                        <asp:ListItem>视频名称</asp:ListItem>
                        <asp:ListItem>存储文件夹</asp:ListItem>
                        <asp:ListItem>组别</asp:ListItem>
                        <asp:ListItem>播放顺序</asp:ListItem>
                    </asp:DropDownList>
                   </td>
      ...
      <tr style="height:350px">
            ...
            <Columns>
                 <asp:BoundField DataField="ID" HeaderText="视频编号" ControlStyle-Width="200px" ItemStyle-Width="200px" >
                  <ControlStyle Width="200px"></ControlStyle>
                  <ItemStyle Width="200px"></ItemStyle>
               </asp:BoundField>
                
                <asp:BoundField DataField="grouptitle" HeaderText="课程名称" ControlStyle-Width="300px" ItemStyle-Width="300px" >
                  <ControlStyle Width="300px"></ControlStyle>
                  <ItemStyle Width="300px"></ItemStyle>
               </asp:BoundField>
               
                <asp:BoundField DataField="videotitle" HeaderText="视频名称" ControlStyle-Width="300px" ItemStyle-Width="300px" >
                  <ControlStyle Width="300px"></ControlStyle>
                  <ItemStyle Width="300px"></ItemStyle>
                </asp:BoundField>
                ...
                <asp:BoundField DataField="videofilename" HeaderText="视频文件名" ControlStyle-Width="300px" ItemStyle-Width="300px" >
                  <ControlStyle Width="300px"></ControlStyle>
                  <ItemStyle Width="300px"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="grouptype" HeaderText="组别" ControlStyle-Width="300px" ItemStyle-Width="300px" >
                  <ControlStyle Width="300px"></ControlStyle>
                  <ItemStyle Width="300px"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="videoindex" HeaderText="播放顺序" ControlStyle-Width="300px" ItemStyle-Width="300px" >
                  <ControlStyle Width="300px"></ControlStyle>
                  <ItemStyle Width="300px"></ItemStyle>
                </asp:BoundField>
                ...
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("ID") %>' CommandName="Del" Width="100px">删除</asp:LinkButton>
                </ItemTemplate>
               </asp:TemplateField>
